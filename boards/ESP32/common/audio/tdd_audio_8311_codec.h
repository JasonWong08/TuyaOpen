/**
 * @file tdd_audio_esp_i2s.h
 * @brief tdd_audio_esp_i2s module is used to
 * @version 0.1
 * @date 2025-04-08
 */

#ifndef __TDD_AUDIO_8311_CODEC_H__
#define __TDD_AUDIO_8311_CODEC_H__
...
typedef struct {
    ...
    uint8_t         pa_output_invert; /*!< 0: PA active-high, 1: PA active-low */
    uint8_t         es8311_addr;
...
#endif /* __TDD_AUDIO_8311_CODEC_H__ */
