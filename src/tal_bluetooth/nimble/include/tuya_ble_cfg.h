...
#define TY_HS_BLE_RPA_TIMEOUT (300)
    ...
    (defined(CONFIG_ENABLE_QUADDLE_BLE_HID_CENTRAL) && CONFIG_ENABLE_QUADDLE_BLE_HID_CENTRAL)
#undef TY_HS_BLE_SM_BONDING
#define TY_HS_BLE_SM_BONDING (1)
#undef TY_HS_BLE_SM_IO_CAP
#define TY_HS_BLE_SM_IO_CAP (BLE_HS_IO_NO_INPUT_OUTPUT)
#undef TY_HS_BLE_SM_LEGACY
#define TY_HS_BLE_SM_LEGACY (1)
#undef TY_HS_BLE_SM_OUR_KEY_DIST
#define TY_HS_BLE_SM_OUR_KEY_DIST (3)
#undef TY_HS_BLE_SM_THEIR_KEY_DIST
#define TY_HS_BLE_SM_THEIR_KEY_DIST (3)
#endif
